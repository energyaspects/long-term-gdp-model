...
extended_region_dict = {
    'Kosovo': {'macro_region': 'EUR'},
    'West_Bank_and_Gaza': {'macro_region': 'ME'}
}

extended_iso_dict = {
    'kosovo': 'None',
    'west_bank_and_gaza': 'None',
    'europe': 'EU',
    'north_america': 'NA',
    'latin_america': 'LA',
    'africa': 'AFR',
...
pop_countries_rename_dict = {'Bolivia (Plurinational State of)': 'Bolivia',
                             ...
                             "China, Hong Kong Special Administrative Region": "Hong_Kong",
